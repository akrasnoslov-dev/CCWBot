...
def build_market_report_prompt(input_payload: dict) -> str:
    ...
    weekly_guidance = (
        ...
        "when they are present. If weekly_context says a block is unavailable, say so directly "
        "and do not invent dates or catalysts. "
    ...
    return (
        ...
        "dashboard is 2-4 concise bullets as strings, grounded in prices, volume, range, "
        "or trend context from input.\n"
        "coin_cards must include one object per active coin with symbol, summary, and watch. "
        "Use supplied coin symbols only.\n"
        "market_catalysts is 0-3 concise market-data strings, not unsourced news claims.\n"
